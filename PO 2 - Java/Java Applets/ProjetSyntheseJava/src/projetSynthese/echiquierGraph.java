    ...
    private class GestionnaireEvenement implements MouseListener
    {
        ...
        public void mouseClicked(MouseEvent e) 
        {
          if (e.getSource() == boutonDebuter)
          {
            ...
            echiquier.getCase(0,2).setPiece(new Fou("FN","noir"));
            ...
            echiquier.getCase(7,0).setPiece(new Tour("TB","blanc"));
            ...
            for (int i=0; i < 8; i++){
              ...
              System.out.println(echiquier.getCase(1,i).getPiece());
            }
            ...
            for (int i=0; i<8; i++)
                for (int j=0; j<8; j++)
                    if (e.getSource() == tabLabel[i][j])
                    {
                      ...
                      if (valid)
                      {
                        boolean deplace = echiquier.cheminPossible(depart,arrivee);
                        if (deplace)
                        {
