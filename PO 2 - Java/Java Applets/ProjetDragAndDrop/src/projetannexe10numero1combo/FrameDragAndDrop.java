  ...
  public FrameDragAndDrop() {
    ...
    private class Ecouteur implements MouseListener, MouseMotionListener {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            posInitialeParRapportaEcran = e.getLocationOnScreen();   // position de l'�v�nement par rapport � l'�cran : attention e.getLocation() emplacement de l'�v�nement par raport � sa source
        ...
        public void mouseReleased(MouseEvent e) {
            ...
            ((JButton)e.getSource()).setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR)); // remettre le curseur r�gulier  
        }
        ...
        public void mouseDragged(MouseEvent e) {
            ...
            Point dragged = e.getLocationOnScreen(); // �v�nement par rapport � l'�cran 
           
            int dragX = (int)(dragged.getX()-posInitialeParRapportaEcran.getX()); // on doit passer par la position par rapport � l'�cran ; pas de position de l'�v�nement par rapport � la fen�tre car la source est le bouton
            int dragY = (int)(dragged.getY()-posInitialeParRapportaEcran.getY());
            
            System.out.println ( e.getX() + "  "+ e.getY()); // la preuve : position de l'�v�nement par rapport � la source  
